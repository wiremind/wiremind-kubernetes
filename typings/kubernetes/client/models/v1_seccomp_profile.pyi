...
class V1SeccompProfile:
    ...
    openapi_types = ...
    attribute_map = ...
    def __init__(self, localhost_profile=..., type=..., local_vars_configuration=...) -> None:
        """V1SeccompProfile - a model defined in OpenAPI"""
        ...
    
    @property
    def localhost_profile(self): # -> None:
    ...
    def localhost_profile(self, localhost_profile): # -> None:
