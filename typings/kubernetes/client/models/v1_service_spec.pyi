...
class V1ServiceSpec:
    ...
    def allocate_load_balancer_node_ports(self, allocate_load_balancer_node_ports): # -> None:
    ...
    @cluster_i_ps.setter
    def cluster_i_ps(self, cluster_i_ps): # -> None:
    ...
    @property
    def external_traffic_policy(self): # -> None:
    ...
    @property
    def health_check_node_port(self): # -> None:
    ...
    @property
    def internal_traffic_policy(self): # -> None:
    ...
    def internal_traffic_policy(self, internal_traffic_policy): # -> None:
    ...
    @ip_families.setter
    def ip_families(self, ip_families): # -> None:
    ...
    @property
    def ip_family_policy(self): # -> None:
    ...
    def ip_family_policy(self, ip_family_policy): # -> None:
    ...
    @property
    def load_balancer_class(self): # -> None:
    ...
    def load_balancer_class(self, load_balancer_class): # -> None:
    ...
    @property
    def load_balancer_ip(self): # -> None:
    ...
    @property
    def load_balancer_source_ranges(self): # -> None:
    ...
    @property
    def publish_not_ready_addresses(self): # -> None:
    ...
    @property
    def session_affinity(self): # -> None:
    ...
    @property
    def session_affinity_config(self): # -> None:
