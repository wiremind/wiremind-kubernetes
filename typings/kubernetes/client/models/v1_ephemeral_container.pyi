...
class V1EphemeralContainer:
    ...
    openapi_types = ...
    attribute_map = ...
    def __init__(self, args=..., command=..., env=..., env_from=..., image=..., image_pull_policy=..., lifecycle=..., liveness_probe=..., name=..., ports=..., readiness_probe=..., resources=..., security_context=..., startup_probe=..., stdin=..., stdin_once=..., target_container_name=..., termination_message_path=..., termination_message_policy=..., tty=..., volume_devices=..., volume_mounts=..., working_dir=..., local_vars_configuration=...) -> None:
    ...
    @property
    def target_container_name(self): # -> None:
