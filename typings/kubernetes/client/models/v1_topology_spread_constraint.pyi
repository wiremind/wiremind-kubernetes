...
class V1TopologySpreadConstraint:
    ...
    openapi_types = ...
    attribute_map = ...
    def __init__(self, label_selector=..., max_skew=..., min_domains=..., topology_key=..., when_unsatisfiable=..., local_vars_configuration=...) -> None:
    ...
    @min_domains.setter
    def min_domains(self, min_domains): # -> None:
    ...
    @property
    def when_unsatisfiable(self): # -> None:
