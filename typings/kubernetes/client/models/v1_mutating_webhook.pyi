...
class V1MutatingWebhook:
    ...
    openapi_types = ...
    attribute_map = ...
    def __init__(self, admission_review_versions=..., client_config=..., failure_policy=..., match_policy=..., name=..., namespace_selector=..., object_selector=..., reinvocation_policy=..., rules=..., side_effects=..., timeout_seconds=..., local_vars_configuration=...) -> None:
    ...
    @property
    def reinvocation_policy(self): # -> None:
